...
**FineChat** is a Ruby on Rails blog application that allows users to send messages to each other that can only be read once.

Submitted by: **Linh**

Time spent: **25** hours

URL: **https://linhweek2homework.herokuapp.com**
...
![Video Walkthrough](http://imgur.com/HBKoCem.gif)
